...
class BaseNoteFormat:
    ...
    M5COVER_LANDSCAPE_X = M5_LANDSCAPE_X
    M5COVER_LANDSCAPE_Y = M5_LANDSCAPE_Y+0.5
    M5COVER_PORTLAIT_X = M5COVER_LANDSCAPE_Y
    M5COVER_PORTLAIT_Y = M5COVER_LANDSCAPE_X
    ...
    # 切り出す1枚のサイズ()
    TARGET_PAGE_X = M5COVER_PORTLAIT_X
    TARGET_PAGE_Y = M5COVER_PORTLAIT_Y

    EDGE_LINE_WIDTH = 0.005
    ...
    def set_property(self):
        ...
        title = 'M5カバー'
        self.pdf_file.setTitle(title)
        self.pdf_file.setSubject(title)
    ...
    def draw_split_line(self, color):
        ...
        self.pdf_file.setStrokeColor(color)
        self.pdf_file.setLineWidth(self.EDGE_LINE_WIDTH * mm)
...
if __name__ == "__main__":
    format = BaseNoteFormat("M5Cover")
    format.create_format(colors.black, "black")
    # format.create_format_color_valiation()
